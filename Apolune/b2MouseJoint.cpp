...
void b2MouseJoint::SetMaxForce(b2decimal force)
{
	m_maxForce = force;
}

b2decimal b2MouseJoint::GetMaxForce() const
{
	return m_maxForce;
}

void b2MouseJoint::SetFrequency(b2decimal hz)
{
	m_frequencyHz = hz;
}

b2decimal b2MouseJoint::GetFrequency() const
{
	return m_frequencyHz;
}

void b2MouseJoint::SetDampingRatio(b2decimal ratio)
{
	m_dampingRatio = ratio;
}

b2decimal b2MouseJoint::GetDampingRatio() const
{
...
void b2MouseJoint::InitVelocityConstraints(const b2TimeStep& step)
{
	...
	b2decimal mass = b->GetMass();

	// Frequency
	b2decimal omega = 2.0 * b2_pi * m_frequencyHz;

	// Damping coefficient
	b2decimal d = 2.0 * mass * m_dampingRatio * omega;

	// Spring stiffness
	b2decimal k = mass * (omega * omega);
	...
	b2decimal invMass = b->m_invMass;
	b2decimal invI = b->m_invI;
...
b2Vec2 b2MouseJoint::GetReactionForce(b2decimal inv_dt) const
{
	return inv_dt * m_impulse;
}

b2decimal b2MouseJoint::GetReactionTorque(b2decimal inv_dt) const
{
	return inv_dt * 0.0;
}
