...
public:	
 ...
 {
 	glViewport(0,0,tres,tres);									// Set Our Viewport (Match Texture Size)
 	...
 	glViewport(x,y,w,h);									// Set Viewport (0,0 to 640x480)
 }
 ...
 bool InitFrame()					// Any GL Init Code & User Initialiazation Goes Here
 {
  ...
  glViewport(x, y, w, h);	// Set Up A Viewport
 ...
 void Between() {
  angle += FRAMETIME;						// Update angle Based On The Clock
 }
