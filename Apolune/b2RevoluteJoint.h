...
struct b2RevoluteJointDef : public b2JointDef
{
	...
	b2decimal lowerAngle;

	/// The upper angle for the joint limit (radians).
	b2decimal upperAngle;
...
public:
	...
	void SetMaxMotorTorque(b2decimal torque);

	/// Get the current motor torque, usually in N-m.
	b2decimal GetMotorTorque() const;
...
protected:
	...
	b2decimal m_motorMass;	// effective mass for motor/limit angular constraint.
	
	bool m_enableMotor;
	b2decimal m_maxMotorTorque;
	b2decimal m_motorSpeed;

	bool m_enableLimit;
	b2decimal m_referenceAngle;
	b2decimal m_lowerAngle;
	b2decimal m_upperAngle;
	b2LimitState m_limitState;
};

inline b2decimal b2RevoluteJoint::GetMotorSpeed() const
{
	return m_motorSpeed;
}
