...
public:
	...
	void SetAsBox(b2decimal hx, b2decimal hy);
	...
	void SetAsBox(b2decimal hx, b2decimal hy, const b2Vec2& center, b2decimal angle);
	...
	void ComputeMass(b2MassData* massData, b2decimal density) const;
...
{
	int bestIndex = 0;
	b2decimal bestValue = b2Dot(m_vertices[0], d);
	for (int i = 1; i < m_vertexCount; ++i)
	{
		b2decimal value = b2Dot(m_vertices[i], d);
		if (value > bestValue)
		{
			bestIndex = i;
			bestValue = value;
