...
class LithophaneTest : public GLWindow {
public:
 ...
 void OnLoad() {
  ...
  lap.Near=0.1;
  lap.Far=1000.0;
  litho.Recycle( new Lithophane("data/images/heightbrushes/jimmy.png",96,96,100,100,10,5) );
  position.x=-litho->size.x/2;
  position.y=-litho->size.y/2;
 }
 void Between() {
