...
bool b2CircleShape::RayCast(b2RayCastOutput* output, const b2RayCastInput& input, const b2Transform& transform) const
{
	...
	b2decimal b = b2Dot(s, s) - m_radius * m_radius;

	// Solve quadratic equation.
	b2Vec2 r = input.p2 - input.p1;
	b2decimal c =  b2Dot(s, r);
	b2decimal rr = b2Dot(r, r);
	b2decimal sigma = c * c - rr * b;
...
void b2CircleShape::ComputeMass(b2MassData* massData, b2decimal density) const
{
