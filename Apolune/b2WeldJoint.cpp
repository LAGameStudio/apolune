...
bool b2WeldJoint::SolvePositionConstraints(b2decimal baumgarte)
{
	...
	b2decimal C2 = bB->m_sweep.a - bA->m_sweep.a - m_referenceAngle;

	// Handle large detachment.
	const b2decimal k_allowedStretch = 10.0 * b2_linearSlop;
	b2decimal positionError = C1.Length();
	b2decimal angularError = b2Abs(C2);
...
b2Vec2 b2WeldJoint::GetReactionForce(b2decimal inv_dt) const
{
	b2Vec2 P(m_impulse.x, m_impulse.y);
	return inv_dt * P;
}

b2decimal b2WeldJoint::GetReactionTorque(b2decimal inv_dt) const
{
