...
extern DECLSPEC void AG_ObjectSetAttachFn(void *, void (*fn)(struct ag_event *), const char *, ...);
extern DECLSPEC void AG_ObjectSetDetachFn(void *, void (*fn)(struct ag_event *), const char *, ...);
