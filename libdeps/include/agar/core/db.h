...
__BEGIN_DECLS
extern DECLSPEC AG_ObjectClass agDbClass;
extern DECLSPEC AG_Db *AG_DbNew(enum ag_db_type);
extern DECLSPEC AG_Db *AG_DbNewDB4(const char *, enum ag_db4_type, Uint32);
extern DECLSPEC AG_List *AG_DbListKeys(AG_Db *);
extern DECLSPEC int AG_DbExists(AG_Db *, const char *);
extern DECLSPEC int AG_DbExistsDK(AG_Db *, void *, size_t);
extern DECLSPEC int AG_DbLookup(AG_Db *, AG_DbEntry *, const char *);
extern DECLSPEC int AG_DbLookupDK(AG_Db *, AG_DbEntry *, void *, size_t);
extern DECLSPEC int AG_DbDelete(AG_Db *, const char *);
extern DECLSPEC int AG_DbDeleteDK(AG_Db *, void *, size_t);
extern DECLSPEC int AG_DbPut(AG_Db *, AG_DbEntry *);
