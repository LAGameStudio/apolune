...
__BEGIN_DECLS 
extern DECLSPEC DWORD AG_XBOX_GetXbeTitleId(const char *xbePath);
extern DECLSPEC char* AG_XBOX_GetDeviceFromLogicalDrive(const char *drive);
extern DECLSPEC BOOL AG_XBOX_DriveIsMounted(const char driveLetter);
extern DECLSPEC BOOL AG_XBOX_PathIsValid(const char *path);
extern DECLSPEC DWORD AG_XBOX_GetLogicalDrives();
__END_DECLS 
