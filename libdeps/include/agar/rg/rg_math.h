...
#define RG_Distance2(ax,ay,bx,by) RG_Norm2((float)((ax)-(bx)), (float)((ay)-(by)))

#if defined(_AGAR_INTERNAL) || defined(_USE_AGAR_RG_MATH)
...
#endif /* _AGAR_INTERNAL or _USE_AGAR_RG_MATH */
