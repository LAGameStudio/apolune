...
extern DECLSPEC AG_TTFFont *AG_TTFOpenFont(const char *, int);
extern DECLSPEC AG_TTFFont *AG_TTFOpenFontFromMemory(const Uint8 *, size_t, int);
extern DECLSPEC void AG_TTFCloseFont(AG_TTFFont *);
extern DECLSPEC int AG_TTFFindGlyph(AG_TTFFont *, Uint32, int);
extern DECLSPEC void AG_TTFSetFontStyle(AG_TTFFont *, int);
extern DECLSPEC int AG_TTFFaceFixedWidth(AG_TTFFont *);
extern DECLSPEC int AG_TTFGlyphMetrics(AG_TTFFont *, Uint32 , int *, int *, int *, int *, int *);
__END_DECLS
