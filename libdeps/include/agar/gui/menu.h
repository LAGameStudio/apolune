...
extern DECLSPEC void AG_MenuCollapse(void *, AG_MenuItem *);
...
extern DECLSPEC AG_MenuItem *AG_MenuActionKb(AG_MenuItem *, const char *, AG_Surface *, AG_KeySym, AG_KeyMod, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuTool(AG_MenuItem *, AG_Toolbar *, const char *, AG_Surface *, AG_KeySym, AG_KeyMod, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuDynamicItem(AG_MenuItem *, const char *, AG_Surface *, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuDynamicItemKb(AG_MenuItem *, const char *, AG_Surface *, AG_KeySym, AG_KeyMod, AG_EventFn, const char *, ...);
