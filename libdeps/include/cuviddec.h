...
#define CUDA_FORCE_API_VERSION  3010    // Currently does not support the new 3.2 apis (64-bit CUdeviceptr)
#endif
#include <cuda.h>
...
typedef struct _CUVIDPROCPARAMS
{
    ...
    unsigned int reserved_zero;  // Reserved for future use (set to zero)
...
extern CUresult CUDAAPI cuvidGetVideoFrameSurface(CUvideodecoder hDecoder, int nPicIdx,
                                                   void **pSrcSurface);
